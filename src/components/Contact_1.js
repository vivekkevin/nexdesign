...
const ContactDetails = styled.div`
  ...
  p {
    display: flex;
    align-items: center;
     /* Ensures the text within paragraphs is left-aligned */
    font-size: 1.2vw;
    margin-bottom: 10px;
...
const SocialIconsContainer = styled.div`
  ...
  gap: 43px; /* Space between the h2 and icons */
  margin-top: 20px;
  margin-left: 7%;
    ...
    <BackgroundWrapper>
      <ContactContainer>
        ...
        <ContactInfo>
          ...
          <a style={{ marginLeft: '25%' }}>© 2024 NEX Design Studio, All Rights Reserved.</a>
        </FooterNav>
        </ContactInfo>
      </ContactContainer>
